...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <head>
      <meta name="google-site-verification" content="ao36HbbSH0XNWxv6733tQPLFxy0xCwaeU3zzKU5zvTE" />
      <script async src="https://www.googletagmanager.com/gtag/js?id=G-W3H6BJDHK5"></script>
        <script
